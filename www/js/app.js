...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.expense-new', {
    ...
    views: {
      'tab-expense': {
        templateUrl: 'templates/tab-expense-new.html',
        controller: 'ExpenseCtrlNew'
      }
    }
  })
  ...
  .state('tab.income-new', {
    url: '/income/new',
    views: {
      'tab-income': {
        templateUrl: 'templates/tab-income-new.html',
        controller: 'CashFlowCtrlNew'
      }
    }
  });
